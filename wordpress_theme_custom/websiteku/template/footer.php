...
<footer class="bg-white">
     ...
     <div class="bg-light py-2">
         <div class="container text-center">
             ...
             &copy; <?php echo date("Y"); ?> <a href="<?php echo home_url(); ?>" class="text-primary"><span class="font-weight-bold"><?php bloginfo('name'); ?></span></a> - Theme By <?=bloginfo('admin_email');?> <br /> <span class="text-dark">Powered by <a href="http//wwww.wordpress.org" target="_blank" class="text-dark">Wordpress</a></span>
